...
public class HomePage extends BasePage {
    ...
    @Step("Отклоняем куки, если окно с ними появляется")
    ...
    @Step("Получаем плейсхолдеры для выбранной услуги")
    ...
    @Step("Получаем плейсхолдеры для всех услуг")
